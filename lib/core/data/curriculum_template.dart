...
/// Template data cho chương trình đào tạo Công nghệ thông tin
/// Tổng cộng 138 tín chỉ theo yêu cầu
  ...
  static Future<List<Section>> getTemplateData() async {
    final sections = [
      Section(
        ...
        requiredCredits: 34,
        optionalCredits: 22,
        description: 'Các môn học cơ bản, rèn luyện tư duy và kỹ năng (56 tín chỉ)',
        id: '1',
        courseGroups: [
          CourseGroup(
            id: '1.1',
      ...
      Section(
        ...
        requiredCredits: 38,
        optionalCredits: 0,
        description: 'Nền tảng cho chuyên ngành (38 tín chỉ)',
        id: '2',
        courseGroups: [
          CourseGroup(
            id: '2.1',
      ...
      Section(
        ...
        requiredCredits: 0,
        optionalCredits: 34,
        description: 'Kiến thức chuyên sâu về ngành học (34 tín chỉ)',
        id: '3',
        courseGroups: [
          CourseGroup(
            id: '3.1',
      ...
      Section(
        ...
        requiredCredits: 0,
        optionalCredits: 10,
        description: 'Kiến thức tổng hợp tốt nghiệp (10 tín chỉ)',
        id: '4',
        courseGroups: [
          CourseGroup(
            id: '4.1',
